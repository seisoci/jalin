<x-app-layout title='Menu Managaer' :config="$config ?? []" :isToastr="true" :isSweetalert="true" :isNestable="true"
              :assets="$assets ?? []"
              :isBanner="false">
   <div>
     <div class="row">
       ...
       <div class="col-sm-6 col-lg-6">
         <form id="changeHierarchy" class="formStore"
               action="{{ route('menu-manager.changeHierarchy') }}">
           @method('POST')
           @csrf
           <div class="card">
