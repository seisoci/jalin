                      ...
                      <div class="d-flex flex-row">
                        <div class="bd-example">
                          <div class="btn-group" role="group" aria-label="Basic example">
                            <a href="{{ route('rekap-netto.index') }}" method="GET"
                               class="btn btn-warning me-2 btnSubmit">
                              <i class="fa-solid fa-eye"></i> Lihat
                            </a>
                            <a href="{{ route('rekap-netto.store') }}" method="POST"
                               class="btn btn-success me-2 btnCompare">
              ...
              <div class="col-md-6">
                <div class="table-responsive">
                  <table id="tableCore" class="table table-sm table-bordered w-100">
                    <thead>
                    <tr>
                      <th colspan="6" class="text-center">Bruto</th>
                    </tr>
                    <tr>
              ...
              <div class="col-md-6">
                <div class="table-responsive">
                  <table id="tableJalin" class="table table-sm table-bordered w-100">
                    <thead>
                    <tr>
                      <th colspan="5" class="text-center">Jalin 56D</th>
                    </tr>
                    <tr>
                      <th>Tgl Trx</th>
                      <th>ACQ</th>
    ...
    <script>
      $(document).ready(function () {
        ...
        $('.btnCompare').on('click', function (e) {
          e.preventDefault();
          let url = `{{ route("rekap-netto.store") }}`;
          Swal.fire({
        ...
        $('.btnDelete').on('click', function (e) {
          ...
          let pk = $('.datePicker').val(),
            url = `{{ route("rekap-netto.index") }}/` + pk;
          Swal.fire({
            title: "Anda Yakin ?",
