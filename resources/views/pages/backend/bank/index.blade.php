  ...
  <div class="modal fade" id="modalCreate" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form id="formStore" method="POST" action="{{ route('bank.store') }}">
          @csrf
    ...
    <script>
      $(document).ready(function () {
        ...
        modalEdit.addEventListener('show.bs.modal', function (event) {
          let kode_bank = event.relatedTarget.getAttribute('data-bs-kode_bank');
          let name = event.relatedTarget.getAttribute('data-bs-name');
          this.querySelector('input[name=kode_bank]').value = kode_bank;
          this.querySelector('input[name=name]').value = nama;
          this.querySelector('#formUpdate').setAttribute('action', '{{ route("bank.index") }}/' + event.relatedTarget.getAttribute('data-bs-id'));
        });
